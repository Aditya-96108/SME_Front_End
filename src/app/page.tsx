...
export default function LandingPage() {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 p-10">
      ...
      <p className="text-lg text-gray-600 mb-10 max-w-md text-center">
        Your smart AI-powered exam assistant designed to streamline your learning experience.
      </p>
